...
def main():
    ...
    print('-- Part c ---------------------------------------')
    # x = tf.math.subtract(a, b)
    # print_vals(x)

    # Sine wave: angle for 0 to 360:
    # 1. Create array holding the numbers
    # 2. for loop
    # angle increments in steps of 1: (convert from degrees to radients)
    radients = []
    for angle in range(0, 360):
        radients.append(tf.math.sin(float(angle)))
